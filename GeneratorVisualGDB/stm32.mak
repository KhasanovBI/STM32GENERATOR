...
#Additional flags
PREPROCESSOR_MACROS += ARM_MATH_CM3 STM32L152RC stm32_flash_layout STM32L152xC
INCLUDE_DIRS += . $(BSP_ROOT)/STM32L1xxxx/STM32L1xx_HAL_Driver/Inc $(BSP_ROOT)/STM32L1xxxx/STM32L1xx_HAL_Driver/Inc/Legacy $(BSP_ROOT)/STM32L1xxxx/CMSIS_HAL/Device/ST/STM32L1xx/Include $(BSP_ROOT)/STM32L1xxxx/CMSIS_HAL/Include $(BSP_ROOT)/STM32L1xxxx/CMSIS_HAL/RTOS/Template $(BSP_ROOT)/FreeRTOS/Source/Include $(BSP_ROOT)/FreeRTOS/Source/Portable/gcc/ARM_CM3
LIBRARY_DIRS += 
...
LINKER_SCRIPT := $(BSP_ROOT)/STM32L1xxxx/LinkerScripts/STM32L152RC_flash.lds
